...
export type { NFTMintingPlatform } from "./contracts/NFTMintingPlatform";
export { NFTMintingPlatform__factory } from "./factories/contracts/NFTMintingPlatform__factory";
