...
export interface NFTMintingPlatformInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface NFTMintingPlatform extends BaseContract {
  connect(runner?: ContractRunner | null): NFTMintingPlatform;
  waitForDeployment(): Promise<this>;

  interface: NFTMintingPlatformInterface;
  ...
  mintNFT: TypedContractMethod<[tokenURI: string], [void], "payable">;
  ...
  togglePublicMint: TypedContractMethod<
    [_enabled: boolean],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[tokenURI: string], [void], "payable">;
  getFunction(
